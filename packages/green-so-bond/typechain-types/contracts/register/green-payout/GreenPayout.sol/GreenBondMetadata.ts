...
export interface GreenBondMetadataInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BND_ROLE"
      | "CAK_ROLE"
...
export interface GreenBondMetadata extends BaseContract {
  connect(runner?: ContractRunner | null): GreenBondMetadata;
  waitForDeployment(): Promise<this>;

  interface: GreenBondMetadataInterface;
