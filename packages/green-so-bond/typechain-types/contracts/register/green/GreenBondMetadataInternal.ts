...
export interface GreenBondMetadataInternalInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BND_ROLE"
      | "CAK_ROLE"
...
export interface GreenBondMetadataInternal extends BaseContract {
  connect(runner?: ContractRunner | null): GreenBondMetadataInternal;
  waitForDeployment(): Promise<this>;

  interface: GreenBondMetadataInternalInterface;
