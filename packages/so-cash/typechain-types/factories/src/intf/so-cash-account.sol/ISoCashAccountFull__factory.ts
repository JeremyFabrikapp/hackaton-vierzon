...
import type {
  ISoCashAccountFull,
  ISoCashAccountFullInterface,
} from "../../../../src/intf/so-cash-account.sol/ISoCashAccountFull";
...
export class ISoCashAccountFull__factory {
  static readonly abi = _abi;
  static createInterface(): ISoCashAccountFullInterface {
    return new Interface(_abi) as ISoCashAccountFullInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ISoCashAccountFull {
    return new Contract(address, _abi, runner) as unknown as ISoCashAccountFull;
  }
}
