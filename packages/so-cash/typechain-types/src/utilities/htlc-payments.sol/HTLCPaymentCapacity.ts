...
export interface HTLCPaymentCapacityInterface extends Interface {
  getFunction(
...
export interface HTLCPaymentCapacity extends BaseContract {
  connect(runner?: ContractRunner | null): HTLCPaymentCapacity;
  waitForDeployment(): Promise<this>;

  interface: HTLCPaymentCapacityInterface;
