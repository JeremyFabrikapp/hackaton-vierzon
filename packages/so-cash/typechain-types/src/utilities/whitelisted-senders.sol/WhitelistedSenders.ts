...
export interface WhitelistedSendersInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "blacklist"
      | "isWhitelisted"
  ...
  getEvent(
    nameOrSignatureOrTopic: "OwnershipTransferred" | "Whitelisted"
  ): EventFragment;
...
export interface WhitelistedSenders extends BaseContract {
  connect(runner?: ContractRunner | null): WhitelistedSenders;
  waitForDeployment(): Promise<this>;

  interface: WhitelistedSendersInterface;
