...
export interface ISoCashAccountFullInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "accountNumber"
      | "allowance"
...
export interface ISoCashAccountFull extends BaseContract {
  connect(runner?: ContractRunner | null): ISoCashAccountFull;
  waitForDeployment(): Promise<this>;

  interface: ISoCashAccountFullInterface;
